...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="ToyId" v-model="value.toyId"/>
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="RentalId" v-model="value.rentalId"/>
          </div>
          <div class="grey--text ml-4" v-else>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="ToyRentalPrice" v-model="value.toyRentalPrice"/>
          </div>
          <div class="grey--text ml-4" v-else>
            ToyRentalPrice :  {{value.toyRentalPrice }}
          </div>

          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="ToyStatus" v-model="value.toyStatus"/>
          </div>
          <div class="grey--text ml-4" v-else>
            ToyStatus :  {{value.toyStatus }}
          </div>
